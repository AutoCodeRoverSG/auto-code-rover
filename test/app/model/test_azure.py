...
def DummyAzureResponse(content="Test response", input_tokens=1, output_tokens=2, tool_calls=None):
...
def test_azure_model_call(monkeypatch, model_class):
    ...
    monkeypatch.setattr(AzureOpenaiModel, "check_endpoint_url", dummy_check_endpoint_url)
