...
def test_gemini_check_api_key_failure(monkeypatch, capsys):
    ...
    assert "Please set the GEMINI_API_KEY or GOOGLE_APPLICATION_CREDENTIALS env var" in captured
...
@pytest.mark.parametrize("model_class", gemini_models.values(), ids=gemini_models.keys())
